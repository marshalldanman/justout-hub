...
(function () {
  ...
  var CHANNELS = [
    ...
    { id:'fpcs',   name:'FPCS',          sub:'hub.justout.today/dashboard/',     desc:'Friendly PC Support \u2014 Tech Jobs & Invoices', type:'crystal', color:'#4ade80', deep:'#166534', icon:'\uD83D\uDDA5\uFE0F', status:'live', count:0, phase:0 },
    { id:'tax',    name:'Tax HQ',        sub:'hub.justout.today/dashboard/',     desc:'FPCS 2022 Tax Dashboard',       type:'star',    color:'#38bdf8', deep:'#1e3a5f', icon:'\uD83D\uDCCA', status:'live',    count:1185, phase:0 },
    { id:'bots',   name:'Bot HQ',        sub:'hub.justout.today/dashboard/bots.html',desc:'Realbotville \u2014 Bot Fleet',  type:'gem',     color:'#a78bfa', deep:'#4c1d95', icon:'\uD83E\uDD16', status:'live',    count:16,   phase:0 },
    ...
    { id:'helpdesk',name:'Helpdesk',     sub:'hub.justout.today/helpdesk/', desc:'Issues & Project Tracker',  type:'star',   color:'#fb923c', deep:'#7c2d12', icon:'\uD83C\uDF9B', status:'live', count:0, phase:0 },
    { id:'security',name:'SentryLion',   sub:'hub.justout.today/dashboard/sentrylion.html', desc:'Endpoint Security & Fleet Protection', type:'prism', color:'#f97316', deep:'#7c2d12', icon:'\uD83E\uDD81', status:'live', count:0, phase:0 },
